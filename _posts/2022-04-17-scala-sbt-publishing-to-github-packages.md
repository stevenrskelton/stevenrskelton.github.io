...
A separate article {% post_url 2022-04-20-downloading-from-github-packages-using-http-and-maven %} has instructions on how to browse and download artifacts from Github Packages using HTTP and Maven.
