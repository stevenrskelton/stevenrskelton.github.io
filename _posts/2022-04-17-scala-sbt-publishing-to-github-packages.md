...
A separate article {% link _posts/2022-04-20-downloading-from-github-packages-using-http-and-maven.md %} has 
instructions on how to browse and download artifacts from Github Packages using HTTP and Maven.
