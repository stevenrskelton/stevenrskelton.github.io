...
> [!NOTE]
> Since we are creating an über jar, the artifact generated by `sbt-assembly` is named `project-assembly`
> instead of `project`

> [!NOTE]
> Locally we would use a GitHub OAuth token for credentials, we could also use it in the GitHub Action but
...
> [!NOTE]
> You may need to adjust your Personal Access Token permissions to check in this file using git since it
